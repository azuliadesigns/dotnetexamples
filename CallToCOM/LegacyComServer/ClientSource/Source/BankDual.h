...
/* at Mon Oct 01 08:14:15 2001
 */
/* Compiler settings for E:\OI\ComFund\Examples\BankDual\BankDual.idl:
...
#define IAccount2_put_Balance(This,newVal)	\
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE IAccount2_put_Balance_Proxy( 
    IAccount2 __RPC_FAR * This,
    /* [in] */ long newVal);


void __RPC_STUB IAccount2_put_Balance_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
